...
namespace JdSoft.Skin.Class
{
    public partial class DrawRectUtil
    {
		...
		public static void DrawImageWithNineRect(Graphics g, Image img, Rectangle targetRect, Rectangle srcRect, int offset)
        {
